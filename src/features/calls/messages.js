const mensagens = {
  ...
  nomeSemPermissao: '❌ O bot não tem permissão para renomear esta call.',
  operacaoExpirada: '❌ A operação demorou mais que o esperado. Tente novamente.',
  operacaoFalhou: '❌ Não foi possível concluir a operação nesta call.',
